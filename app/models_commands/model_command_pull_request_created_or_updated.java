 ...
 */
public class model_command_pull_request_created_or_updated {
    public final String comment_body;
    public final model_repo repo;
    public final model_pull_request pull_request;
    public model_command_pull_request_created_or_updated(model_repo p_repo, model_pull_request p_pull_request) {
        this.repo = p_repo;
