...
public class model_offer_for_merge extends Model {
    ...
    public model_offer_for_merge(model_user p_user, model_pull_request p_pull_request, BigDecimal p_amount_percent, Boolean p_is_active, Boolean p_was_positively_accepted, Boolean p_date_created, Boolean p_date_accepted_if_accepted) {
