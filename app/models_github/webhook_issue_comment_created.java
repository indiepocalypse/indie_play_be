 ...
 */
public class webhook_issue_comment_created {
    ...
    public webhook_issue_comment_created(
            String p_action,
            model_issue p_issue,
    ...
    public static webhook_issue_comment_created from_json(JsonNode json) {
        ...
        return new webhook_issue_comment_created(
                action,
                issue,
                comment,
                repo,
