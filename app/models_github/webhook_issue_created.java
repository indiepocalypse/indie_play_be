 ...
 */
public class webhook_issue_created {
    ...
    public static webhook_issue_created from_json(JsonNode json) {
        ...
        return new webhook_issue_created(
                action,
                issue,
                repo,
                user
